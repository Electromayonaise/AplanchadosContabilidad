    ...
    private void initUI() {
        ...
        modifyButton.addActionListener(e -> {
            ...
            if (selectedIndex != -1) {
                ...
                int choice = JOptionPane.showOptionDialog(ExpensesPanel.this, "What would you like to modify?", "Modify Task", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                ...
                if (choice == 0) {
                    ...
                    JOptionPane.showMessageDialog(ExpensesPanel.this, slider, "Select new Task Priority", JOptionPane.QUESTION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(ExpensesPanel.this, "Task modified successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
                // Refresh the display panel to update the displayed tasks
                refreshDisplay();
            } else {
                JOptionPane.showMessageDialog(ExpensesPanel.this, "Please select a task first.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        deleteButton.addActionListener(e -> {
            ...
            if (selectedIndex != -1) {
                ...
                JOptionPane.showMessageDialog(ExpensesPanel.this, "Task deleted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(ExpensesPanel.this, "Please select a task first.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        addButton.addActionListener(e -> {
            ...
            if (taskName != null && !taskName.isEmpty()) {
                JSlider slider = getjSlider();
                JOptionPane.showMessageDialog(ExpensesPanel.this, slider, "Select Task Priority", JOptionPane.QUESTION_MESSAGE);
                ...
                if (taskDescription != null) {
                    ...
                    if (success) {
                        refreshDisplay();
                        JOptionPane.showMessageDialog(ExpensesPanel.this, "Task added successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(ExpensesPanel.this, "Task with the same name already exists.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
