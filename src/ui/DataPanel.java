...
/**
 * The DataPanel class represents a panel for managing tasks in the Task Manager application.
...
public class DataPanel extends BasePanel {
     ...
     */
    public DataPanel(JPanel containerPanel) {
    ...
    private void initUI() {
        ...
        modifyButton.addActionListener(e -> {
            ...
            if (selectedIndex != -1) {
                ...
                int choice = JOptionPane.showOptionDialog(DataPanel.this, "What would you like to modify?", "Modify Task", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                ...
                if (choice == 0) {
                    ...
                    JOptionPane.showMessageDialog(DataPanel.this, slider, "Select new Task Priority", JOptionPane.QUESTION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(DataPanel.this, "Task modified successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
                // Refresh the display panel to update the displayed tasks
                refreshDisplay();
            } else {
                JOptionPane.showMessageDialog(DataPanel.this, "Please select a task first.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        deleteButton.addActionListener(e -> {
            ...
            if (selectedIndex != -1) {
                ...
                JOptionPane.showMessageDialog(DataPanel.this, "Task deleted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(DataPanel.this, "Please select a task first.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        addButton.addActionListener(e -> {
            ...
            if (taskName != null && !taskName.isEmpty()) {
                JSlider slider = getjSlider();
                JOptionPane.showMessageDialog(DataPanel.this, slider, "Select Task Priority", JOptionPane.QUESTION_MESSAGE);
                ...
                if (taskDescription != null) {
                    ...
                    if (success) {
                        refreshDisplay();
                        JOptionPane.showMessageDialog(DataPanel.this, "Task added successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(DataPanel.this, "Task with the same name already exists.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
        ...
        undoButton.addActionListener(e -> {
            ...
            if(undo){
                refreshDisplay();
                JOptionPane.showMessageDialog(DataPanel.this, "Undo successful.", "Success", JOptionPane.INFORMATION_MESSAGE);

            }else{
                JOptionPane.showMessageDialog(DataPanel.this, "No undo possible", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
